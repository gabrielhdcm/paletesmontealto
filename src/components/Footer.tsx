...
export function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[linear-gradient(180deg,#1f2937_0%,#111827_100%)] px-4 py-10 text-slate-300 sm:px-6 sm:py-14 lg:px-8">
            ...
            <div>
              ...
              <div className="mt-4 grid gap-4">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center justify-center rounded-lg bg-[linear-gradient(135deg,#228B22,#2fb14b)] px-4 py-3 text-sm font-semibold text-white"
                >
