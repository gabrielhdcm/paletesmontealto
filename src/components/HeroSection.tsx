...
export function HeroSection() {
  return (
    <section
      id="inicio"
      className="hero-bg relative isolate min-h-screen overflow-hidden scroll-mt-28 px-4 pb-12 pt-20 sm:px-6 sm:pb-20 sm:pt-28 lg:px-8 lg:pb-24 lg:pt-36"
    >
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        >
          <h1 className="mt-16 max-w-3xl font-display text-3xl leading-[1.05] tracking-[-0.03em] text-white sm:mt-20 sm:text-5xl sm:leading-[0.95] sm:tracking-[-0.04em] lg:mt-24 lg:text-7xl">
            {company.name}
          </h1>
